...
int button_is_clickedbackmenu(button_t button, sfVector2i click_position)
{
    ...
    button_pos = sfRectangleShape_getPosition(button.rect_pausbackmenu);
...
void check_mouse_pause(button_t button, sfVector2i mouse_pos, info_t *info)
{
    ...
    if (mouse_pos.x >= button_pos.x &&
        ...
        sfRectangleShape_setTextureRect(button.rect_putinpause,
        info->start_rect);
        sfRectangleShape_setTexture(button.rect_putinpause,
...
void check_mouse_resume(button_t button, sfVector2i mouse_pos, info_t *info)
{
    ...
    if (mouse_pos.x >= button_pos.x &&
        ...
        info->start_rect.width = 70;
        info->start_rect.height = 80;
        sfRectangleShape_setTextureRect(button.rect_pausresume,
        info->start_rect);
        sfRectangleShape_setTexture(button.rect_pausresume,
        info->second_button_normal, 0);
    }
...
void check_mouse_backmenu(button_t button, sfVector2i mouse_pos, info_t *info)
{
    ...
    if (mouse_pos.x >= button_pos.x &&
        ...
        info->start_rect.width = 70;
        info->start_rect.height = 80;
        sfRectangleShape_setTextureRect(button.rect_pausbackmenu,
        info->start_rect);
        sfRectangleShape_setTexture(button.rect_pausbackmenu,
        info->second_button_normal, 0);
    }
...
void check_mouse_exitgame(button_t button, sfVector2i mouse_pos, info_t *info)
{
    ...
    if (mouse_pos.x >= button_pos.x &&
        ...
        info->start_rect.width = 70;
        info->start_rect.height = 80;
        sfRectangleShape_setTextureRect(button.rect_pausupsound,
        info->start_rect);
        sfRectangleShape_setTexture(button.rect_pausupsound,
        info->second_button_normal, 0);
    }
